...
127.0.0.1/mod_mysql_basic_imdb_movies/movies/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod_mysql_basic_imdb_movies

   Weergave van records 0 - 24 (98 totaal, Query duurde 0,0017 seconden.)
